...
<html>
  <head>
	...
	<meta name="author" content="Syahrun Dalu">
    <!-- Bootstrap 3.3.4 -->
    ...
    <div class="wrapper">
      ...
      <header class="main-header">
        ...
        <a href="<?php echo site_url(); ?>/manager" class="logo">
          ...
          <span class="logo-mini"><b>KelTam</b></span>
          <!-- logo for regular state and mobile devices -->
          <span class="logo-lg"><b>Kelas Tambahan</b></span>
        </a>
      ...
      <footer class="main-footer">
        ...
        <strong>&copy; 2023 syahrundalu</strong>
      </footer>
