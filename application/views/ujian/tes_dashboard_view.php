<div class="container">
    ...
    <section class="content-header">
    	<h1>
    		<b>SELAMAT DATANG</b> <?php if(!empty($nama)){ echo $nama; } if(!empty($group)){ echo ' | '.$group; } ?>
    ...
    <section class="content">
		...
		?>
        <div class="box box-warning shadow box-solid rounded">
            <div class="box-header with-border">
                <h3 class="box-title">Daftar Tes</h3>
            </div><!-- /.box-header -->
            <div class="box-body">
                <table id="table-tes" class="table table-dark table-bordered table-hover">
                    <thead>
                        <tr>
                            <th>No.</th>
                            <th class="all">Tes</th>
